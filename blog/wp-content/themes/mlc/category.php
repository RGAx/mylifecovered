 	    ...
 	    <div class="row">
 	        <div class="col-md-8">
				...
				$category_id = get_query_var('cat');
 	        	...
 	        	$featured_posts = get_posts(array("posts_per_page"=>1,"post_type"=>"post", "post_status"=>"publish", "meta_key"=>"featured", "meta_value"=>true, "category"=>$category_id));
			...
			<div class="col-md-4">
				<?php get_search_form(); ?>
				<?php
               	if($current_page == 1) $sidebar_posts = get_posts(array("posts_per_page"=>2,"offset"=>1, "post_type"=>"post", "post_status"=>"publish", "meta_key"=>"featured", "meta_value"=>true, "category"=>$category_id));
