...
<head id="<?php echo of_get_option('meta_headid'); ?>" data-template-set="html5-reset-wordpress-theme">
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/_/css/xperience.css?v=2.3.3">
    <!--[if IE 9]>
...
<body <?php body_class(); ?>>
	...
	Activity name of this tag: My Life Covered Universal Content Page Tag
	URL of the webpage where the tag is expected to be placed: http://blog.mylifecovered.net/
	...
	document.write('<iframe src="https://6194995.fls.doubleclick.net/activityi;src=6194995;type=mylif00;cat=mylif0;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=1;num=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
	</script>
	<noscript>
	<iframe src="https://6194995.fls.doubleclick.net/activityi;src=6194995;type=mylif00;cat=mylif0;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=1;num=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
	</noscript>
    ...
    <div id="body_wrapper">
        ...
        <section id="top-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <a id="#myLifeCoveredHeader" href="https://www.mylifecovered.com/" class="open-home-page-copy">
