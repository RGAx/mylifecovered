...
- Should the input on the Life Insurance Child-Level landing for **I Know How Much I Need** be a text box or a dropdown? If dropdown, needed is a list of value options and a default value option.
