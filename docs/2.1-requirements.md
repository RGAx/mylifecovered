...
- User choices/actions:
  ...
  - Clicking the **I Know What I Can Afford** buttont takes the user to the Insurance Child-Level Landing page with the **I Know What I Can Afford** option showcased:
