...
<!--  <section id="needs-calculator" class="main-section" style="display:none">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ul class="progress-bar">
                        <li class="current"><img src="resources/images/icon-calculator.svg" alt="">Calculate Coverage</li>
                ...
                <div class="col-md-6 col-md-offset-3 text-center" id="needsCalculatorErrorMsgId">
                    ...
                    <form action="" id="needs-calculator-form" name="needsCalculatorForm">
                        ...
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id="retirementSavings" name="retirementSavings" value="0">
                            <label class=" " for="retirementSavings">Retirement Savings</label>
                        </div>
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id="otherSavings" name="otherSavings" value="0">
                            <label class=" " for="otherSavings">Other Savings</label>
                        </div>
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id="annualIncome" name="annualIncome" value="0">
                            <label class=" " for="annualIncome">Your Annual Income</label>
                        </div>
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id="yearsIncomeProvided" name="yearsIncomeProvided" value="0">
                            <label class=" " for="yearsIncomeProvided">Years of Income Needed for Beneficiaries</label>
                        </div>
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id=existingLifeInsurance name="existingLifeInsurance" value="0">
                            <label class=" " for="existingLifeInsurance">Your Existing Life Insurance Coverage</label>
                        </div>
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id="finalExpenses" name="finalExpenses" value="15000">
                            <label class=" " for="finalExpenses">Funeral Expenses</label>
                        </div>
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id="outstandingMortgage" name="outstandingMortgage" value="0">
                            <label class=" " for="outstandingMortgage">Outstanding Mortgage</label>
                        </div>
                        <div class="inline-text required">
                            <input class=" " type="text" pattern="[0-9]*" id="otherOutstandingDebt" name="otherOutstandingDebt" value="0">
                            <label class=" " for="otherOutstandingDebt">Other Outstanding Debt</label>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="inline-text required">
                                    <input class=" " type="text" pattern="[1-9]|10" id="estimatedInflationRate" name="estimatedInflationRate" value="3">
                                    <label class=" " for="estimatedInflationRate">Estimated Inflation Rate</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="inline-text required">
                                    <input class=" " type="text" pattern="[1-9]|10" id="estimatedInvestmentReturn" name="estimatedInvestmentReturn" value="6">
    ...
    <section id="calculator-report" class="cover main-section" style="display:block">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ul class="progress-bar quote-bar">
                        <!-- <li><a href="quote.do" class="open-needs-calculator"><img src="resources/images/icon-calculator.svg" alt="">Calculate Coverage</a></li> -->
            ...
            <div class="row">
                <!-- <div id="coverage-analysis" class="col-md-5 col-md-offset-1" style="visibility:hidden;">
                    ...
                    <div id="edit-coverage">
                        <a href="quote.do" class="open-needs-calculator">
                ...
                <div class="col-md-12 text-center margin-bottom-s quote-i-want"><h3 class="text-center">Get Your Quote</h3></div>
                <div id="quote-calculator">
                <div id="calculator-demographics" class="col-md-5 col-md-offset-1 ">
                    ...
                    <form action="" id="needs-calculator-demographics-form" name="needsCalculatorDemographicsForm">
                        ...
                        <br>
                        <div class="text-center">
                            <input type="button" class="btn btn-primary" value="Next" id="quote-form-submit" wpvalue="next" onclick="validateQuote('iKnowWhatINeed')">
                        </div>
