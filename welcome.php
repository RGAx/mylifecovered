	...
	<section id="hero" class="section-photo cover text-center">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-md-12">
	                    ...
	                    <a href="calculator.php" id="how_much_do_i_need" class="btn btn-primary margin-top-s" wpvalue="find_your_low_rate" onclick="quoteVisiblity('howMuchDoINeed')">How much do I need?</a>
						 <a href="quote.php" id="i_know_what_i_need" class="btn btn-primary margin-top-s" onclick="quoteVisiblity('iKnowWhatINeed')">I know what I need</a>
	                </div>
	            </div>
	            <!--</br>
	            <div class="row">
	    ...
	    <section id="red-banner">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-md-12">
	                    <p>Applying for coverage and committing to coverage are not the same thing. The final decision is always yours.</p>
	                </div>
	            </div>
	        </div>
	    </section>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
	                <div class="col-md-12 text-center margin-top-l">
	                    <div><a href="calculator.php" class="btn btn-primary open-get-started" id="getStartedWithInsuranceNeeds1" wpvalue="get_started">Get Started</a></div>
	                    <div class="padding-top-s"><a href="basics.php" class="secondary open-basics">Need a life insurance primer? Learn the basics.</a></div>
	                </div>
	            </div>
	        </div>
	    </section>
